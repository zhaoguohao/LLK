...
public class UnityEngine_ParticleSystemWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("safeCollisionEventSize", get_safeCollisionEventSize, null);
	...
	static int GetCollisionEvents(IntPtr L)
	{
		try
		{
			...
			UnityEngine.ParticleSystem.CollisionEvent[] arg1 = ToLua.CheckObjectArray<UnityEngine.ParticleSystem.CollisionEvent>(L, 3);
	...
	static int get_safeCollisionEventSize(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)o;
			int ret = obj.safeCollisionEventSize;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index safeCollisionEventSize on a nil value" : e.Message);
		}
	}
