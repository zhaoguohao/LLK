...
public class UnityEngine_AudioSourceWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("panLevel", get_panLevel, set_panLevel);
	...
	static int get_panLevel(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.AudioSource obj = (UnityEngine.AudioSource)o;
			float ret = obj.panLevel;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index panLevel on a nil value" : e.Message);
		}
	}
	...
	static int get_pan(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index pan on a nil value" : e.Message);
		}
	}
