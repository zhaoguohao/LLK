...
public class UnityEngine_ShaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetGlobalTexGenMode", SetGlobalTexGenMode);
		L.RegFunction("SetGlobalTextureMatrixName", SetGlobalTextureMatrixName);
	...
	static int SetGlobalTexGenMode(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.TexGenMode arg1 = (UnityEngine.TexGenMode)ToLua.CheckObject(L, 2, typeof(UnityEngine.TexGenMode));
