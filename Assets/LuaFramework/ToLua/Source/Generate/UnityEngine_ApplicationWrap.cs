...
public class UnityEngine_ApplicationWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("RegisterLogCallbackThreaded", RegisterLogCallbackThreaded);
	...
	static int RegisterLogCallback(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Application.LogCallback arg0 = null;
			LuaTypes funcType1 = LuaDLL.lua_type(L, 1);

			if (funcType1 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (UnityEngine.Application.LogCallback)ToLua.CheckObject(L, 1, typeof(UnityEngine.Application.LogCallback));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 1);
				arg0 = DelegateFactory.CreateDelegate(typeof(UnityEngine.Application.LogCallback), func) as UnityEngine.Application.LogCallback;
			}
