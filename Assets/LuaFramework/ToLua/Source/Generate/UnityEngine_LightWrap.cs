...
public class UnityEngine_LightWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("shadowSoftness", get_shadowSoftness, set_shadowSoftness);
		L.RegVar("shadowSoftnessFade", get_shadowSoftnessFade, set_shadowSoftnessFade);
	...
	static int get_shadowSoftness(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			float ret = obj.shadowSoftness;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index shadowSoftness on a nil value" : e.Message);
		}
	}
	...
	static int get_shadowSoftnessFade(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			float ret = obj.shadowSoftnessFade;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index shadowSoftnessFade on a nil value" : e.Message);
		}
	}
