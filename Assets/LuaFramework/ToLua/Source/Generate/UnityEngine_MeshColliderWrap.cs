...
public class UnityEngine_MeshColliderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("smoothSphereCollisions", get_smoothSphereCollisions, set_smoothSphereCollisions);
		L.EndClass();
	}
	...
	static int get_smoothSphereCollisions(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.MeshCollider obj = (UnityEngine.MeshCollider)o;
			bool ret = obj.smoothSphereCollisions;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index smoothSphereCollisions on a nil value" : e.Message);
		}
	}
	...
	static int set_smoothSphereCollisions(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.MeshCollider obj = (UnityEngine.MeshCollider)o;
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			obj.smoothSphereCollisions = arg0;
			return 0;
		}
		catch(Exception e)
		{
