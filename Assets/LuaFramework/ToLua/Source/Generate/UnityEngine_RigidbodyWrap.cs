...
public class UnityEngine_RigidbodyWrap
{
	...
	static int get_sleepVelocity(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index sleepVelocity on a nil value" : e.Message);
		}
	}
	...
	static int get_sleepAngularVelocity(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)o;
			float ret = obj.sleepAngularVelocity;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index sleepAngularVelocity on a nil value" : e.Message);
		}
	}
