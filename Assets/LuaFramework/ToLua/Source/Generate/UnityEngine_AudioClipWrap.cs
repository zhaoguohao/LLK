...
public class UnityEngine_AudioClipWrap
{
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			if (count == 6 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool), typeof(bool)))
			{
			...
			else if (count == 7 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool), typeof(bool), typeof(UnityEngine.AudioClip.PCMReaderCallback)))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
				...
				bool arg4 = LuaDLL.lua_toboolean(L, 5);
				bool arg5 = LuaDLL.lua_toboolean(L, 6);
				UnityEngine.AudioClip.PCMReaderCallback arg6 = null;
				LuaTypes funcType7 = LuaDLL.lua_type(L, 7);

				if (funcType7 != LuaTypes.LUA_TFUNCTION)
				{
					 arg6 = (UnityEngine.AudioClip.PCMReaderCallback)ToLua.ToObject(L, 7);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 7);
					arg6 = DelegateFactory.CreateDelegate(typeof(UnityEngine.AudioClip.PCMReaderCallback), func) as UnityEngine.AudioClip.PCMReaderCallback;
				}
			...
			else if (count == 8 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool), typeof(bool), typeof(UnityEngine.AudioClip.PCMReaderCallback), typeof(UnityEngine.AudioClip.PCMSetPositionCallback)))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
				...
				UnityEngine.AudioClip.PCMSetPositionCallback arg7 = null;
				LuaTypes funcType8 = LuaDLL.lua_type(L, 8);

				if (funcType8 != LuaTypes.LUA_TFUNCTION)
				{
					 arg7 = (UnityEngine.AudioClip.PCMSetPositionCallback)ToLua.ToObject(L, 8);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 8);
					arg7 = DelegateFactory.CreateDelegate(typeof(UnityEngine.AudioClip.PCMSetPositionCallback), func) as UnityEngine.AudioClip.PCMSetPositionCallback;
				}
	...
	static int get_isReadyToPlay(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isReadyToPlay on a nil value" : e.Message);
		}
	}
