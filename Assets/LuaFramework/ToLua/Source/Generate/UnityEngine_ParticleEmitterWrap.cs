...
public class UnityEngine_ParticleEmitterWrap
{
	...
	static int _CreateUnityEngine_ParticleEmitter(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UnityEngine.ParticleEmitter obj = new UnityEngine.ParticleEmitter();
				ToLua.Push(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.ParticleEmitter.New");
			}
		}
		catch(Exception e)
		{
